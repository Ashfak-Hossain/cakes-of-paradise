/*
  ...
  - You are about to drop the column `customer_id` on the `CustomOrder` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "CustomOrder" DROP CONSTRAINT "CustomOrder_customer_id_fkey";

-- DropForeignKey
ALTER TABLE "Order" DROP CONSTRAINT "Order_customer_id_fkey";

-- AlterTable
ALTER TABLE "CustomOrder" DROP COLUMN "customer_id",
...
-- AlterTable
ALTER TABLE "Product" ALTER COLUMN "is_available" SET DEFAULT false;
